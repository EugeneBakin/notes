...
И снова про аттестацию.

Вознаграждение за заслуги порождает разногласия и раздоры.

Также стоит отметить, что результат работы зависит в некоторой (довольно большой) степени от системы.

Сотрудник, получивший плохую оценку в одном отделе может расцвести в другом.

Лимитирование общей суммы баллов ведет к система WIN-LOSE.

Если все сотрудники даже теоретически не могут получить высшую оценку - система нечестная.

Работа над продуктом становится вторичной по отношению к личному рейтингу. Если будет способ сделать лучше себе (своему рейтингу) в ущерб продукту - это будут делать.

Целью становится не качество, а ублажение начальства.

Единственный, кому должно быть позволено оценивать работу - потребитель (внешний или внутренний).

Аттестация заставляет мыслить теми временными инетервалами, за которые проводится. Т.е. нет смысла ставить цели на срок более аттестационного, если к сроку предоставить скорее всего нечего, или даже будет просадка по продуктовым показателям.

Уровнение вариабельности:
x + y + [xy] = R

x - вклад сотрудника
y - вклад системы
[xy] - влкда взаимодействия
R - результат

Мы даем оценку x имея на руках только R

Также у аттестующего есть предвзятость к людям, получившим плохую или хорошую оценку несколько раз подряд.

Эффект Пигмаллиона - от сотрудника, получившего низкую оценку уже не ждут положительных результатов, что провоцирует его получать плохие оценки и далее.

## 13 - Образование

**Учредите программу образования. Поощряйте самообразование.**

Здесь важно различие между тренингом и образованием.

Тренинг - то, что нужно здесь и сейчас для выполнения задач. Объем материала в тренинге ограничен обязанностями сторудника.

Образование - неграничено ничем и нельзя предсказать где оно принесет плоды.
